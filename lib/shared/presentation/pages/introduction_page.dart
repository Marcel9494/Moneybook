...
class _IntroductionPageState extends State<IntroductionPage> {
  ...
  void _checkStartConditions() {
    ...
    BlocProvider.of<booking.BookingBloc>(context).add(const booking.HandleAndUpdateNewBookings());
        ...
        return IntroductionScreen(
          ...
          pages: [
            ...
            PageViewModel(
              ...
              bodyWidget: const Text(
                'Erstelle monatliche Budgets und behalte sie stets im Blick.',
                style: TextStyle(color: Colors.white, fontSize: 18.0),
                textAlign: TextAlign.center,
              ),
              image: Padding(
            ...
            PageViewModel(
              ...
              bodyWidget: const Text(
                'Behalte jederzeit den Überblick über all deine Konten und Investitionen – einfach, klar und organisiert.',
                style: TextStyle(color: Colors.white, fontSize: 18.0),
                textAlign: TextAlign.center,
              ),
              image: Padding(
